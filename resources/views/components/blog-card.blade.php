...
<div
    ...
    <a href="/categories/{{ $categorySlug }}"><span class="text-purple-700 px-2 py-1 rounded ">{{ $category }}</span></a>
    <a href="{{ $link }}"><h3 class="text-2xl font-bold">{{ Str::words($title, 6) }}</h3></a>
